...
<img src='https://i.imgur.com/7cIcxkY.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Instructions were somewhat vague and hard to understand. Some parts of the guides would not allow xcode to build at all. Setting up constraints were still a big issue. 
